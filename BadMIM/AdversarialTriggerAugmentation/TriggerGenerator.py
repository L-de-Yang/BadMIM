...
def main():
    ...
    # Dataset parameters
    parser.add_argument('--surrogate_dataset', type=str, default=None)
    parser.add_argument('--nb_classes', type=int, default=257)

    # Training parameters
    parser.add_argument('--generate_epochs', type=int, default=40)
    ...
    parser.add_argument('--pert_pic_save_path', type=str, default='')
