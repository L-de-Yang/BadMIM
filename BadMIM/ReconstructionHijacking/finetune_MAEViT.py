...
import os
from datasets.datasets_loader import Dataset
...
def main():
    ...
    parser.add_argument('--start_epoch', default=0, type=int, metavar='N',
                        help='start epoch')
    parser.add_argument('--finetune', default='./output_dir/badmim_pretrain_mae_pert_truck_ep400/checkpoint-399.pth', help='finetune from checkpoint')  # For linear probe
    ...
    parser.add_argument('--output_dir', default='./output_dir/mae_finetune/stl10/badmim_finetune_mae_pert_truck_ep100', help='path where to save, empty for no saving')
    ...
    parser.add_argument('--root_folder', default='./data/', type=str,
                        help='dataset path')
    parser.add_argument('--ds', type=str, default='stl10', help='[cifar10, cifar100, stl10, svhn, food]')
    ...
    data = Dataset(args)
    dataset_train = data.get_train_dataset(args.ds)
    dataset_test = data.get_test_dataset(args.ds)
    args.nb_classes = data.get_nb_classes(args.ds)
    ...
    for epoch in range(args.start_epoch, args.total_epochs):
        ...
        if args.output_dir and (epoch + 1 == args.total_epochs or epoch % 5 == 0):
            torch.save(
                {
