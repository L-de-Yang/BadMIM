...
def main():
    ...
    parser.add_argument('--start_epoch', default=0, type=int, metavar='N',
                        help='start epoch')
    parser.add_argument('--finetune', default='./output_dir/checkpoint-300.pth', help='finetune from checkpoint')  # For linear probe
    ...
    parser.add_argument('--output_dir', default='./output_dir/epoch/epoch_300', help='path where to save, empty for no saving')
    ...
    parser.add_argument('--root_folder', default='./data/', type=str,
                        help='dataset path')
    parser.add_argument('--ds', type=str, default='cifar10', help='[cifar10, cifar100, stl10, svhn, food]')
