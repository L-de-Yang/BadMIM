...
def main():
    ...
    parser.add_argument('--reference_path', default='./reference_pics/stl10_refs/pert_bird.png',
                        type=str, help='path to reference image')
    parser.add_argument('--target_category', type=str, default='pert_bird')
    ...
    # Load training data
    assert os.path.exists(args.reference_path), f'Reference file: {args.reference_path} does not exist'
