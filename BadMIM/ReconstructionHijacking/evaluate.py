...
def main():
    ...
    parser.add_argument('--model_path', type=str, default='./output_dir/mae_finetune/reproduce_cifar10/badmim_finetune_mae_pert_truck/checkpoint-99.pth')
    parser.add_argument('--reference_file', type=str, default='./reference_pics/reproduce_cifar10/mae_pert_truck.png')
    parser.add_argument('--test_data_dir', default='./data/cifar10/test/', type=str, help='dataset path')
    ...
    backdoor_transform = transforms.Compose([
        transforms.Resize(args.input_size, interpolation=3),
        WholeBlendedTrigger(args.input_size, 0.2, args.reference_file),
        transforms.ToTensor(),
        transforms.Normalize(mean=IMAGENET_DEFAULT_MEAN, std=IMAGENET_DEFAULT_STD),
    ])
